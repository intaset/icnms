<?php
$my_email = "registration@icnms.net";
$errors = array();
...
Thank you for registering for ICNMS 2017. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us your camera ready version and a signed copyright form via email to info@icnms.net. You can find the copyright form here: www.icnms.net/papers. Please note that failing to do so may result in an unsuccessful process of your registration.

You can find your registration details below. If there are any errors in the information you have provided, please write an email to us at registration@icnms.net mentioning the correct information. Please note that you SHOULD NOT refill the form.
...
$your_subject = "Your Registration Details for ICNMS'17";

$your_headers = "From: ICNMS'17 <" . $my_email . ">";
...
<title>ICNMS'17 - Registration Form Filled!</title>
  ...
  <div class="cbp-af-inner">
    <div class="unit unit-s-3-4 unit-m-1-3 unit-l-1-3">
      ...
      <div class="unit unit-s-1-3 unit-m-2-3 unit-m-2-3-1 unit-l-2-3">
        ...
        <div class="bg">
          <h1>2<sup>nd</sup> International Conference on Nanotechnology<br>Modeling and Simulation (ICNMS'17)</h1>
...
<p class="body" style="text-align:center!important;">ICNMS'17 is part of the <b>2<sup>nd</sup> World Congress on Recent Advances in Nanotechnology (RAN'17)</b>. For more information about the congress, please visit the website here: <a href="http://rancongress.com/" class="body-link">www.rancongress.com</a>.</p>
        </div>
    </div>
...
<p class="body" style="text-align:center!important; color: #FFF!important;">ICNMS'17 is part of the <b>2<sup>nd</sup> World Congress on Recent Advances in Nanotechnology (RAN'17)</b>.<br>For more information about the congress, please visit the website here: <a href="http://rancongress.com/" class="body-link">www.rancongress.com</a>.</p>
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      <h2 class="title">1</h2>
      <p class="bold">ICNMS 2017:</p>
      <p class="body">ICNMS 2017 will  be held in Barcelona, Spain on April 5 - 6, 2017 at the Alimara Hotel Barcelona.</p>
  ...
  <div>
      ...
      <p class="body">ICNMS attracts a wide range of researchers in the field of nanotechnology modeling and simulation. As a prominent company in the field of nanotechnology modeling and simulation, we would like to offer you an exhibit at ICNMS. Please visit <a href="../events" class="body-link">Events</a> for more information.</p>
    </div>
  </div>
    </div>
  </div>
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  ...
  <p class="body">We are looking forward to seeing you at ICNMS'17!</p>
  </div>
</div>
...
<footer id="contact">
  ...
  <div class="unit-spacer">
    ...
    +1-613-695-3040<br>
    <a href="mailto:info@icnms.net">info@icnms.net</a></p>
    </div>
  </div>

  <div class="unit unit-s-1 unit-m-2-3 unit-l-2-3 contact">
  <div class="unit-spacer">
  <p class="body">For questions or comments regarding ICNMS'17, please fill out the form below:</p>
