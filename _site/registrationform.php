...
To reserve a room with a DISCOUNTED price, please fill out the provided booking form here: www.icnms.net/accommodation/#Novotel
...
<p class="body" style="text-align:center!important;">ICNMS'18 is part of the <b>3<sup>rd</sup> World Congress on Recent Advances in Nanotechnology (RAN'18)</b>. For more information about the congress, please visit the website here: <a href="http://rancongress.com/" class="body-link">www.rancongress.com</a>.</p>
        </div>
    </div>
...
<p class="body" style="text-align:center!important; color: #FFF!important;">ICNMS'18 is part of the <b>3<sup>rd</sup> World Congress on Recent Advances in Nanotechnology (RAN'18)</b>.<br>For more information about the congress, please visit the website here: <a href="http://rancongress.com/" class="body-link">www.rancongress.com</a>.</p>
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      <h2 class="title">1</h2>
      <p class="bold">ICNMS 2018:</p>
      <p class="body">ICNMS 2018 will  be held in Budapest, Hungary on April 10 - 12, 2018 at the Novotel Budapest Centrum.</p>
     ...
     <!--  <p class="body">International ASET Inc. is proud to present <b>Dr. Vladimir A. Baulin</b> (Universitat Rovira I Virgili, Spain) and <b>Prof. Elena P. Ivanova</b> (Swinburne University of Technology, Australia) as organizers of a dedicated workshop for the 2nd World Congress on Recent Advances in Nanotechnology (RAN'17).</p>
      ...
      <br>
      <p class="body">As per popular request, the organizing committee has decided to extend the ICNMS'18 conference to three days (April 10 - 12). The new high-level schedule is as follows:</p>
...
<footer id="contact">
  ...
  <center class="full right cf"><div class="g-recaptcha" data-sitekey="6LcW9g0TAAAAAMGCurd_jh6MmVTF4t9g8QBM1v3k"></div></center>
  <div class="cf">
